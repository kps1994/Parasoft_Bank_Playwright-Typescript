...
import { getPOSTAPIRequestBody } from "../../fixture/APIHelper.ts";

import { faker } from "@faker-js/faker";

import tokenAPIRequest from "../../test_data/api_requests/Token_API_Request.json";
import patchAPIRequest from "../../test_data/api_requests/PATCH_API_Request.json";
...
test(
  "[10,11] Create DELETE API Request using playwright & typescript",
  {
    tag: [
  ...
  async ({ request }) => {
    ...
    console.log(
      "PATCH API Response : " + JSON.stringify(patchAPIJSONResponse, null, 2),
    );
